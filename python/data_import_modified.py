...
def data_import(data_type, seed_range, seed_number = 1, particle_type = '', prefix = '', path = '', 
                nevents = 10000, img_size = 33, nb_chan = 1):
    ...
    if data_type == 'jetimage':
        ...
        return heppy.load_images([gluon_string.format(x) for x in seed_range],
                                 [quark_string.format(x) for x in seed_range],
